...
<head>
  ...
  <title>Credito Global | Clientes</title>
                ...
                <div class="tabbable ">
                    <ul class="nav nav-tabs">
                        <li class="active" id="Ntab1">
                            <a href="#tab1" id="atab1" data-toggle="tab">Lista</a>
                        </li>
                        <li id="Ntab2">
                    ...
                    <div class="tab-content"><div id="_AJAX_LOGIN_"></div>
                        <div class="tab-pane active" id="tab1">
                            
                            
                            <?php include('Clientes/List.php'); ?>
