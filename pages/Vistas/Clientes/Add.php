              ...
              <form id="add">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-6"> 
                      <label>CURP</label>                   
                      <input type="text" class="form-control col-md-6 curp" placeholder="CURP" id="curp">
                    </div>
                    <div class="col-md-6">
                      <label>RFC</label>
                      <input type="text" class="form-control col-md-6 texto" placeholder="RFC" id="rfc">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label>Direccion</label>
                    <textarea class="form-control" placeholder="Direccion texto" id="direccion"></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-6">  
                      <label>Empresa</label>                  
                      <input type="text" class="form-control col-md-6 texto" placeholder="Empresa" id="empresa">
                    </div>
                    <div class="col-md-6">
                      <label>Puesto</label>
                      <input type="text" class="form-control col-md-6 texto" data-mask placeholder="Puesto" id="puesto">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-6">  
                      ...
                      <input type="text" class="form-control col-md-6 telefono" placeholder="Telefono Oficina" id="teloficina">
                    </div>
                    <div class="col-md-6">
                      <label>Extencion</label>
                      <input type="text" class="form-control col-md-6" data-mask placeholder="Extencion" id="extencion">
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">  
                  <div class="col-md-12">
                    <div class="box-footer">
                      <button onclick="add('Clientes')" class="btn btn-primary">Guardar</button>
                    </div>
                  </div>
                </div>
